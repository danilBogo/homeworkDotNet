...
namespace Tests
{
    public class Tests
    {
        ...
        // {
        //     // var a = Message.WrongArgFormatInt;
        //     // Message.WrongArgFormatInt
        ...
        // {
        //     Assert.Equal((int) Message.SuccessfulExecution, Homework2.Program.Main(args));
        // }
        //
        // [Theory]
        // [InlineData(new object[] { new string[] { "4", "-", "3" } })]
        ...
        // {
        //     Assert.Equal((int) Message.WrongArgFormatInt, Homework2.Program.Main(args));
        // }
        //
        // [Theory]
        // [InlineData(new object[] { new string[] { "3", "+", "f" } })]
        ...
        // {
        //     Assert.Equal((int) Message.WrongArgFormatOperation, Homework2.Program.Main(args));
        // }
        //
        // [Theory]
        // [InlineData(new object[] { new string[] { "3", "+", "4", "5" } })]
        ...
        // {
        //     Assert.Equal((int) Message.WrongArgLength, Homework2.Program.Main(args));
        // }
        //
        // [Theory]
        // [InlineData(new object[] { new string[] { "f", ".", "4" } })]
        ...
        // {
        //     Assert.Equal((int) Message.DividingByZero, Homework2.Program.Main(args));
        // }
    }
}